...
**Note:** there currently is no documentation on how to edit PixelQuest-specific objects/layers in Tiled. Please refer to `tmx/map.tmx` as an example if you want to create your own map.
...
- Write documentation about map editing in the Tiled editor (ie. editing PixelQuest-specific properties of doors, chests, spawning areas, etc.)

- Write documentation about the PixelQuest map JSON format, both for client and server map types.
